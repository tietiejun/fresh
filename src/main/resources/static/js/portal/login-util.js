var LOGIN = {
    ...
    getVerifyCode:function(identifyTag){
        var _self = this,
            timestamp = Date.parse(new Date());
        var s = _self.APPURL + '/img-verifyCodes' + '?timestamp=' + timestamp + '&identifyTag=' + identifyTag;
        return s;
    },
    ...
    sendCode : function(postData,callback){
        var _self = this;
        $.ajax({
            url:_self.APPURL+'/message/activeCode',
            type: 'POST',
            data: postData,
            dataType: 'json',
            success:function(responseText){
    ...
    checkActiveCode:function(postData,callback){
        ...
        $.ajax({
            type: "POST",
            url: _self.APPURL+"/sms-verifyCodes/activation",
            dataType: "json",
